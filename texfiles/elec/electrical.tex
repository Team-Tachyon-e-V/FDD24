...
Our electrical system provides the electrical power for the 
propulsion and control systems. We have a low voltage circuit at 24V (for control systems) and a high voltage level circuit at 444V (for the traction system).
...
\\
The motor is a motorsports motor from Emrax. Even though it belongs to the traction system,
