...
%approximate compile duration: 15s
...
%\includeonly{texfiles/elec/electrical} % This is to include only the electrical file. This is useful for testing purposes.
\begin{document}
...
%System Overview
\include{texfiles/general/systemoverview}
